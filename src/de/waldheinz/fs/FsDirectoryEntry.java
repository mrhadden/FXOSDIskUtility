...
public interface FsDirectoryEntry extends FsObject
{
	...
	/**
	 * Compares directory entries alphabetically, with all directories coming before
	 * all files.
	 */
	 ...
	 *
	 * @return the last modification time of the entry as milliseconds since 1970,
	 *         or {@code 0} if this filesystem does not support getting the last
	 *         modification time
	 * @throws IOException
	...
	/**
	 * Gets the directory this entry refers to. This method can only be called if
	 * <code>isDirectory</code> returns true.
	 * 
