...
abstract class BootSector extends Sector
{
	...
	public void init() throws IOException
	{
		...
		/*
		 * magic bytes needed by some windows versions to recognize a boot sector. these
		 * are x86 jump instructions which lead into nirvana when executed, but we're
		 * currently unable to produce really bootable images anyway. So...
		 */
		set8(0x00, 0xeb);
		set8(0x01, 0x3c);
		set8(0x02, 0x90);
