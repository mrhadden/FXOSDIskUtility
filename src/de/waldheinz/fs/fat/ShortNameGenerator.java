...
final class ShortNameGenerator
{
	 ...
	 * specified set to avoid short-name collisions. It will never generate a short
	 * name that is already contained in the specified set, neither will the
	 * specified set be modified by this class. This class can be used to generate
	 * any number of short file names.
	 *
	 * @param usedNames
	...
	/**
	 * Generates a new unique 8.3 file name that is not already contained in the set
