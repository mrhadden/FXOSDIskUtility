...
public class FileSystemFactory
{
	...
	/**
	 * <p>
	 * Creates a new {@link FileSystem} for the specified {@code device}. When using
	 * this method, care must be taken that there is only one {@code FileSystems}
	 * accessing the specified {@link BlockDevice}. Otherwise severe file system
	 ...
	 * @throws IOException
	 *             on read error, or if the file system type could not be determined
	 */
