...
public final class FileDisk implements BlockDevice
{
	 ...
	 * @param readOnly
	 *            if the file should be opened in read-only mode, which will result
	 *            in a read-only {@code FileDisk} instance
	...
	/**
	 * Creates a new {@code FileDisk} of the specified size. The {@code FileDisk}
	 ...
	 *             if size is &lt; 0
	 */
	public static FileDisk create(File file, long size) throws IOException, IllegalArgumentException
	{
