...
final class Fat16RootDirectory extends AbstractDirectory
{
	 ...
	 * {@code Fat16BootSector}. The directory will always be created in read-write
	 * mode.
	 *
	 * @param bs
	...
	/**
	 * By convention always returns 0, as the FAT12/16 root directory is not stored
	 * in a cluster chain.
	 *
	 * @return always 0
	 */
	...
	/**
	 * As a FAT12/16 root directory can not change it's size, this method throws a
	 * {@code DirectoryFullException} if the requested size is larger than
