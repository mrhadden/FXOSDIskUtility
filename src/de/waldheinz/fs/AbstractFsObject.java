...
public class AbstractFsObject implements FsObject
{
	...
	/**
	 * Creates a new instance of {@code AbstractFsObject} which will be valid and
	 * have the specified read-only state.
	 *
	 * @param readOnly
	...
	/**
	 * Convience method to check if this object is writable. An object is writable
	 * if it is both, valid and not read-only.
	 *
	 * @throws IllegalStateException
	 *             if this object was invalidated
