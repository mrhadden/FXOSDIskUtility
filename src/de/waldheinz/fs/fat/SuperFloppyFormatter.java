...
public final class SuperFloppyFormatter
{
	 ...
	 */
	public final static String DEFAULT_OEM_NAME = "FMXLIB"; // NOI18N
	...
	/**
	 * Retruns a {@code SuperFloppyFormatter} instance suitable for formatting the
	 * specified device.
	 *
	 * @param dev
	...
	/**
	 * Initializes the boot sector and file system for the device. The file system
	 * created by this method will always be in read-write mode.
	 *
	...
	private int sectorsPerCluster16() throws IOException
	{
		...
		return sectors > 2097152 ? 64
				: sectors > 1048576 ? 32 : sectors > 524288 ? 16 : sectors > 262144 ? 8 : sectors > 32680 ? 4 : 2;
	}
