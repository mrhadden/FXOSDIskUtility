...
/**
 * This factory creates instances of image handlers for certain types of floppy
 * disk images.
 *
...
public class ImageHandlerFactory
{
	...
	/**
	 * Get the image handler for a certain image type. Get the matching type for a
	 * certain given file by using
	 * 
	 * <pre>
	 ...
	 *
	 * @param type
	 *            The type of disk image to load.
