...
public interface FsObject
{
	 ...
	 * All invocations on methods (except this method and the methods inherited from
	 * {@link Object}) of invalid objects must throw an
	 ...
	 * read-only {@code FsObject} must result in a {@link ReadOnlyException} being
	 * thrown, and the modification must not be performed.
	 *
