...
public final class FatFile extends AbstractFsObject implements FsFile
{
	...
	/**
	 * Returns the length of this file in bytes. This is the length that is stored
	 ...
	 * {@link #write(long, ByteBuffer) writing} to the file will grow it
	 * automatically if needed, this method is mainly usefull for truncating a file.
	 *
	 * @param length
	 ...
	 * </p>
	 * <p>
	 * Unless this file is {@link #isReadOnly() read-ony}, this method also updates
	 * the "last accessed" field in the directory entry that is associated with this
	 * file.
	 * </p>
	 * 
	 * @param offset
	 ...
	 * length} of this file, an attempt is made to {@link #setLength(long) grow} the
	 * file so that the data will fit. Additionally, this method updates the "last
	 * accessed" and "last modified" fields on the directory entry that is
	...
	/**
	 * Has no effect besides possibly throwing an {@code ReadOnlyException}. To make
	 * sure that all data is written out to disk use the
