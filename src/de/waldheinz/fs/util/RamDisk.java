...
public final class RamDisk implements BlockDevice
{
	...
	/**
	 * Creates a new instance of {@code RamDisk} of this specified size and using
	 * the {@link #DEFAULT_SECTOR_SIZE}.
	 *
	 * @param size
	...
	/**
	 * Creates a new instance of {@code RamDisk} of this specified size and sector
	 * size
	 *
	 * @param size
	 *            the size of the new block device
	...
	public void write(long devOffset, ByteBuffer src) throws IOException
	{
		...
		if (devOffset + src.remaining() > getSize())
			throw new IllegalArgumentException(
					"offset=" + devOffset + ", length=" + src.remaining() + ", size=" + getSize());
	 ...
	 * (reflecting any changes made through the {@link #write(long, ByteBuffer)
	 * method}, but read-only.
	 *
