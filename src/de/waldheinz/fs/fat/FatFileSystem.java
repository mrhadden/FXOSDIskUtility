...
public final class FatFileSystem extends AbstractFileSystem
{
	...
	/**
	 * Reads the file system structure from the specified {@code BlockDevice} and
	 * returns a fresh {@code FatFileSystem} instance to read or modify it.
	 *
	 * @param device
	 *            the {@code BlockDevice} holding the file system
	 * @param readOnly
	 ...
	 * @throws IOException
	 *             on read error or if the file system structure could not be parsed
	 */
