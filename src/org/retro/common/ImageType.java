...
/**
 * Lists all supported image types. The lowercase prefix part of the name
 * specifies the computer platform, the suffix the disk image type suffix.
 *
...
public enum ImageType
{
	 ...
	 *
	 * @param platform
	 *            The computer platform name.
	 * @param fileSuffix
	 *            The file suffix of this type.
	 */
	...
	/**
	 * Returns the name of the computer platform this image type is used for (e.g.
	 * "MS DOS" or "Atari ST").
	 *
	...
	/**
	 * Returns the matching type for the given suffix, or null, if the suffix could
	 * not be matched.
	 *
	 * @param suffix
	 *            The filename suffix (with or without ".").
	 * @return The matching type (may be "unknown").
	 */
	public static ImageType getTypeFromFileSuffix(String suffix)
	{
		return Arrays.stream(ImageType.values()).filter(t -> suffix.toUpperCase().endsWith(t.getFileSuffix()))
