...
final class Fat16BootSector extends BootSector
{
	...
	/**
	 * The maximum number of clusters for a FAT12 file system. This is actually the
	 * number of clusters where mkdosfs stop complaining about a FAT16 partition
	 * having not enough sectors, so it would be misinterpreted as FAT12 without
	 * special handling.
	 *
