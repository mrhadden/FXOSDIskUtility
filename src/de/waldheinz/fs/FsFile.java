...
public interface FsFile extends FsObject
{
	...
	/**
	 * Reads from this file into the specified {@code ByteBuffer}. The first byte
	 * read will be put into the buffer at it's {@link ByteBuffer#position()
	 * position}, and the number of bytes read will equal the buffer's
	 * {@link ByteBuffer#remaining() remaining} bytes.
	 * 
	 * @param offset
