...
final class FsInfoSector extends Sector
{
	 ...
	 *
	 * @param bs
	 *            the boot sector that specifies where the FS info sector is stored
	...
	/**
	 * Returns the number of free clusters on the file system as sepcified by the
	 * 32-bit value at {@link #FREE_CLUSTERS_OFFSET}.
	 *
