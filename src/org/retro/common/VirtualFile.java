...
public class VirtualFile implements Comparable<VirtualFile>
{
	...
	/**
	 * UUID that uniquely identifies this file. This is generated randomly every
	 * time the file is read from a floppy disk image.
	 *
	...
	/**
	 * Returns the filename suffix, if there is one. Which is the part after the
	 * last "." in the simple filename, e.g. ".prg" for "something.prg".
	 *
	...
	/**
	 * Returns the full path filename of this file, i.e. the name of the file
	 * preceeded by all parent directories.
	 *
	 ...
	 *            The name of this file.
	 * @param content
	 *            The data contents of this file.
	 */
	...
	/**
	 * Returns the parent directory of this file, if there is one.
	 *
	 ...
	 *
	 * @param target
	 *            The target (aka new parent) directory.
	 */
	 ...
	 *             If the method was called for a directory.
	 */
