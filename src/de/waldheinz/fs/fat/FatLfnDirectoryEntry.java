...
public final class FatLfnDirectoryEntry extends AbstractFsObject implements FsDirectoryEntry
{
	...
	/**
	 * Sets the "hidden" flag on this {@code FatLfnDirectoryEntry} to the specified
	 * value.
	 *
	 * @param hidden
	...
	/**
	 * Sets the "system" flag on this {@code FatLfnDirectoryEntry} to the specified
	 * value.
	 *
	 * @param systemEntry
	...
	/**
	 * Returns if this directory entry has the FAT "read-only" flag set. This entry
	 * may still modified if {@link #isReadOnly()} returns {@code true}.
	 *
	 ...
	 * specified value. This method only modifies the read-only flag as specified by
	 * the FAT file system, which is essentially ignored by the fat32-lib. The true
	 * indicator if it is possible to alter this
	 *
	 * @param readOnly
	...
	/**
	 * Sets the "archive" flag on this {@code FatLfnDirectoryEntry} to the specified
	 * value.
	 *
	 * @param archive
	...
	private static FatDirectoryEntry createPart(FatType type, String subName, int ordinal, byte checkSum,
			boolean isLast)
	{
