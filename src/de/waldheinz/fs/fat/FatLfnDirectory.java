...
public final class FatLfnDirectory extends AbstractFsObject implements FsDirectory
{
	...
	/**
	 * This set is used to check if a file name is already in use in this directory.
	 * The FAT specification says that file names must be unique ignoring the case,
	 * so this set contains all names converted to lower-case, and all checks must
	 * be performed using lower-case strings.
	 */
	 ...
	 * </p>
	 * <p>
	 * According to the FAT file system specification, leading and trailing spaces
	 * in the {@code name} are ignored by this method.
	 * </p>
	 * 
	 * @param name
	 *            {@inheritDoc}
